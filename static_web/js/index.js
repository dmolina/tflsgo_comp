...
$('#figures_link').focus();eval(self.figures_js);$('figures img').addClass('img-fluid');},appendFiguresHighcharts:function(plots){var self=this;div=document.getElementById('figures');div.innerHTML='';var num=plots.length;for(var i=1;i<=num;i++){new_div=document.createElement("div");new_div.id='figures'+i;div.append(new_div);}
...
else if(charts=='highcharts'){figures=data['figures'];self.appendFiguresHighcharts(figures);var num=figures.length;for(var i=0;i<num;i++){console.log(figures[i]);var src="new Highcharts.Chart("+figures[i]+");";eval(src);}}
