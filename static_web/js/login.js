...
else{this.algs=[];}},set_all:function(){var self=this;var all=document.getElementById('all');if(all.checked){self.sel_algs=self.algs;all.name='None';}
else{self.sel_algs=[];all.name='All';}}}});